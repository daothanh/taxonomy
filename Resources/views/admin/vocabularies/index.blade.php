                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>{{ trans('taxonomy::vocabularies.table.name') }}</th>
                                <th>{{ trans('taxonomy::vocabularies.table.description') }}</th>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('admin.taxonomy.vocabulary.edit', [$vocabulary->id]) }}">
                                        {{ $vocabulary->name }}
                                    </a>
                                </td>
                                <td>{{ $vocabulary->description }}</td>
                                <td>{{ $vocabulary->machine_name }}</td>
                                <td>
                                    <div class="btn-group">
                                        <a title="{{ trans('taxonomy::terms.list resource') }}" href="{{ route('admin.taxonomy.term.index', [$vocabulary->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-list"></i></a>
                                        <a href="{{ route('admin.taxonomy.vocabulary.edit', [$vocabulary->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
